...
bool MarlinUI::detected() { return true; }
  ...
  void MarlinUI::show_bootscreen() {
    ...
    #endif
    //show_marlin_bootscreen(); //Marlin Bootscreen is disabled because the custom OpenSlider bootscreen includes "Runs on MarlinFw.org"
  }
