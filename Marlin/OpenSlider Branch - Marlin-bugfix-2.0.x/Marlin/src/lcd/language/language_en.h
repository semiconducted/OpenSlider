...
namespace Language_en {
  ...
  PROGMEM Language_Str MSG_SLOW_MOVE                       = _UxGT("Slow Movement");
  ...
  PROGMEM Language_Str MSG_RESET_PRINTER                   = _UxGT("Reset");
  ...
  PROGMEM Language_Str MSG_INFO_MENU                       = _UxGT("About Machine");
  PROGMEM Language_Str MSG_INFO_PRINTER_MENU               = _UxGT("Machine Info");
  ...
  PROGMEM Language_Str MSG_INFO_STATS_MENU                 = _UxGT("Machine Stats");
  ...
  PROGMEM Language_Str MSG_EXPECTED_PRINTER                = _UxGT("INCORRECT");
